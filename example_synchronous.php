...
$email = 'osgaye@mitaoe.ac.in';
$apiKey = 'c8232a3f-062f-4c0a-a777-54f9a50140e9';
...
try{
	...
	$process  = $clCloud->createByURL($row['url']);
	...
	echo "<div class='container' style='margin-top:2%; border:1px solid black; box-shadow: 0 15px 30px grey;'>";
